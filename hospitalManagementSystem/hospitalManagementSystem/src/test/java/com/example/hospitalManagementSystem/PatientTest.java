...
import com.example.hospitalManagementSystem.dto.BloodGroupCountResponseEntity;
...
//        Patient patient = patientRepository.findById(1L).orElseThrow(()-> new EntityNotFoundException("Paitent not"+
//                "found with id: 1"));

//            Patient patient = patientRepository.findByName("Diya Patel");

//            List <Patient> patientList = patientRepository.findByBirthDateOrEmail(LocalDate.of(1988,03,15),"diya" +
//                    ".patel@example.com");
