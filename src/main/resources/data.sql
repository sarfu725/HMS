...
VALUES
    ('Arav Sharma', 'MALE', '2002-02-22', 'arav.sharma@example.com', 'O_POSITIVE', CURRENT_TIMESTAMP),
    ...
    ('Kabir Singh', 'MALE', '1993-07-15', 'kabir.singh@example.com', 'O_POSITIVE', CURRENT_TIMESTAMP);
